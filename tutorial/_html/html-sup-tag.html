...
<p>Kebalikan dari element <code>&lt;sup&gt;</code> ini adalah element <a href="/tutorial/html/html-sub-tag.html">&lt;sub&gt;</a> yang menunjukkan <i>subscript</i> yang ditulis agak kebawah dari teks normal.</p>
  ...
  <div class="icard-heading clearfix co-wh bg-pi2">
    <div class="icard-bar">
      ...
      <div class="icard-bar-right pull-right">
        <a href="/example/html/tag/sup.html" target="_blank"><span>editor</span><i class="fa fa-external-link"></i></a>
      </div>
    </div>
  </div>
