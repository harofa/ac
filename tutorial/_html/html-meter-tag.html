...
<p><code>&lt;meter&gt;</code> tag tidak boleh digunakan apabila menunjukkan sebuah progres (berlangsungnya sebuah kegiatan). Untuk hal ini, gunakan <a href="/tutorial/html/html-progress-tag.html">&lt;progress&gt;</a> element.</p>
  ...
  <div class="icard-heading clearfix co-wh bg-pi2">
    <div class="icard-bar">
      ...
      <div class="icard-bar-right pull-right">
        <a href="/example/html/tag/meter.html" target="_blank"><span>editor</span><i class="fa fa-external-link"></i></a>
      </div>
    </div>
  </div>
