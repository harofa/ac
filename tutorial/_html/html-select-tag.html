...
<p>Penggunaan element &lt;select&gt; dapat ditulis bersamaan dengan element <a href="/tutorial/html/html-option-tag.html" title="HTML option element">&lt;option&gt;</a> yang berisi daftar pilihan (opsi) yang dapat ditulis beberapa item sebagai daftar pilihan yang akan diseleksi oleh user.</p>
  ...
  <div class="icard-heading clearfix co-wh bg-pi2">
    <div class="icard-bar">
      ...
      <div class="icard-bar-right pull-right">
        <a href="/example/html/tag/select.html" target="_blank"><span>editor</span><i class="fa fa-external-link"></i></a>
      </div>
    </div>
  </div>
