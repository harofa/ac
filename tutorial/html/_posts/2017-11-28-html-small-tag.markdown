---
layout: post
title: "HTML small tag | belajar &lt;small&gt; element"
short_title: "HTML &lt;small&gt; Tag"
language: id

metadata:
  description: "Referensi belajar HTML &lt;small&gt; tag. Tutorial dan panduan mengenai element &lt;small&gt;...&lt;/small&gt;, penjelasan dengan contoh kode penggunaan sebagai referensi belajar HTML &lt;small&gt;"
...
taxonomy:
  ...
  tag: [html, htmltag]
images:
  figure: "posts/html-small-tag.png"
  thumb: "posts/thumbs/html-small-tag.png"
---
<p class="text-muted">
  Referensi Belajar <strong>HTML small tag</strong>. Tutorial dan panduan mengenai element <code>&lt;small&gt;...&lt;/small&gt;</code> yang menunjukkan tulisan kecil atau lebih rendah. Mencakup pembahasan lebih detail dan lengkap yang disertai contoh kode penggunaan sebagai rujukan untuk materi belajar HTML <span lang="id">elemen</span> &lt;small&gt;.
</p>
<hr class="uk-article-divider">

<h2 class="title-sub bd-danger bd-left bd-left-only">Deskripsi <br>
    <small>Penjelasan HTML <span class="html-tag">small</span> tag</small>
</h2>
<p>
  <strong>HTML <code>&lt;small&gt;</code> element</strong> merepresentasikan tulisan lebih kecil atau disebut juga "fine print" atau "small print".
</p>
<p><code>&lt;small&gt;</code> element biasanya digunakan pada sebuah catatan kaki (<em>footer</em>) yang terletak di bawah halawan sebuah website, seperti pada sebuah tulisan hak cipta (<em>copyright</em>), <em>disclaimer</em> dan sisi komentar.</p>
...
<section id="global-attribute">
  ...
  <div class="">
    <p>&lt;small&gt; tag mencakup <em>global attributes</em>.</p>
...
<section>
  ...
  <div class="dul-callout dul-callout-warning">
    <p>&lt;small&gt; tag mencakup <em>event attributes</em>. </p>
    <div>
...
<section id="example">
  <h2 class="title-sub bd-danger bd-left bd-left-only">Example<br>
    <small>Contoh HTML <code>&lt;small&gt;</code> element</small>
  </h2>
    <!-- HTML Code Example -->
    <div class="icard">
...
<pre class="prettyprint linenums line-numbers highlight language-markup"><code data-language="html" class="html  language-markup"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>footer</span><span class="token punctuation">&gt;</span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>small</span><span class="token punctuation">&gt;</span></span>Copyright 2016 apacara.com.<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>small</span><span class="token punctuation">&gt;</span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>small</span><span class="token punctuation">&gt;</span></span>Designed by Fadlullah Fadul<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>small</span><span class="token punctuation">&gt;</span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>footer</span><span class="token punctuation">&gt;</span></span><span aria-hidden="true" class="line-numbers-rows"><span></span><span></span><span></span><span></span></span></code>
</pre>
    </div>
  </div>
</section>
  ...
  <div class="icard-heading clearfix co-wh bg-pi2">
    <div class="icard-bar">
      ...
      <div class="icard-bar-right pull-right">
        <a href="https://www.apacara.com/example/html/tag/small.html" target="_blank"><span>editor</span><i class="fa fa-external-link" role="button"></i></a>
      </div>
    </div>
  </div>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>html</span><span class="token punctuation">&gt;</span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>head</span><span class="token punctuation">&gt;</span></span>
    ...
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>title</span><span class="token punctuation">&gt;</span></span>Demo HTML small tag by:apacara.com<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>title</span><span class="token punctuation">&gt;</span></span>
  ...
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>body</span><span class="token punctuation">&gt;</span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>header</span><span class="token punctuation">&gt;</span></span>
      <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>h1</span><span class="token punctuation">&gt;</span></span>apacara.com Blog<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>h1</span><span class="token punctuation">&gt;</span></span>
    ...
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>article</span><span class="token punctuation">&gt;</span></span>
      <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>header</span><span class="token punctuation">&gt;</span></span>
        <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>h2</span><span class="token punctuation">&gt;</span></span>Definisi Web Standard<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>h2</span><span class="token punctuation">&gt;</span></span>
...
<div class="dul-block">
  ...
  <p>CSS untuk element <code>&lt;small&gt;</code> yang mungkin akan diberlakukan ketika awal inisial.</p>
  <div class="icode itheme css">
<pre class="prettyprint highlight language-css"><code data-language="css" class=" inline language-css"><span class="token selector">small</span> <span class="token punctuation">{</span>
