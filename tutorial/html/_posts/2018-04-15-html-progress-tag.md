...
<p>Element <code>&lt;progress&gt;</code> tidak tepat digunakan untuk menunjukkan sebuah meteran atau ukuran (<i>gauge</i>), seperti mengukur kapasitas hardisk / flashdisk atau sejenisnya. Untuk menunjukkan sebuah ukuran, dapat menggunakan element <a href="/tutorial/html/html-meter-tag.html">&lt;meter&gt;</a>.</p>
  ...
  <div class="icard-heading clearfix co-wh bg-pi2">
    <div class="icard-bar">
      ...
      <div class="icard-bar-right pull-right">
        <a href="/example/html/tag/progress.html" target="_blank"><span>editor</span><i class="fa fa-external-link"></i></a>
      </div>
    </div>
  </div>
