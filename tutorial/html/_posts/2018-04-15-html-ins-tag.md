...
<b>T</b>=<b>T</b>ime (Waktu), <b>+07:00</b> menunjukkan Waktu Indonesia Barat (WIB).</li>
  ...
  <p>Pelajari selengkapnya mengenai HTML attribute <a href="/tutorial/html/html-datetime-attribute.html" title="belajar HTML datetime attribute">datetime</a>.</p>
</div>
  ...
  <div class="icard-heading clearfix co-wh bg-pi2">
    <div class="icard-bar">
      ...
      <div class="icard-bar-right pull-right">
        <a href="/example/html/tag/ins.html" target="_blank"><span>editor</span><i class="fa fa-external-link"></i></a>
      </div>
    </div>
  </div>
