...
<p>Kebalikan dari element <code>&lt;sub&gt;</code> ini adalah element <a href="/tutorial/html/html-sup-tag.html">&lt;sup&gt;</a> yang menunjukkan <i>superscript</i> yang ditulis agak keatas dari teks normal.</p>
  ...
  <div class="icard-heading clearfix co-wh bg-pi2">
    <div class="icard-bar">
      ...
      <div class="icard-bar-right pull-right">
        <a href="/example/html/tag/sub.html" target="_blank"><span>editor</span><i class="fa fa-external-link"></i></a>
      </div>
    </div>
  </div>
